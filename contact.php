            ...
            <ul class="spost_nav">
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/bveclogo.jpg"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Campus A:
UB Junction Opposite UNICS Bank,
Campus B:
Malingo Street,
Molyko Buea - Cameroon</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/m3.jpg"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Mail Us - info@landmarkmetropolitanuniversity.com</a> </div>
                </div>
              </li>
              <li>
                <div class="media wow fadeInDown"> <a href="#" class="media-left"> <img alt="" src="images/call3.png"> </a>
                  <div class="media-body"> <a href="#" class="catg_title"> Call Us - +(237)-672-339-570 //
+(237)-694-990-622</a> </div>
                </div>
              </li>
