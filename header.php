  ...
  <header id="header">
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <a href="index.php" class="logo"><img src="images/LANDMARK.JPG.png" alt="" style="height:100px;" align="right"></a>
        <a href="index.php" class="logo"><img src="images/lmu.png" alt="" style="height:100px;" align="left"></a>
        </div>
      </div>
    </div>
  </header>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav main_nav">
          ...
          <li><a href="prestudent.php">pre student</a></li>
